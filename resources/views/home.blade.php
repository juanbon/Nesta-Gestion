...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
				...
				<table class="table table-bordered">
					...
					<tbody id="dashboard_pending_incidents">
						...
						<tr>
							...
							<td>{{ $incident->created_at }}</td>
							<td>{{ $incident->title_short }}</td>
							<td><a href="/incidencia/{{ $incident->id }}/atender" class="btn btn-primary btn-sm">Atender</a></td>
						</tr>
						@endforeach 
					</tbody>
				</table>
        ...
        <div class="panel panel-success">
			<div class="panel-heading">
				<h3 class="panel-title">Incidencias reportadas por mi</h3>
			</div>
			<div class="panel-body">
				<table class="table table-bordered">
					<thead>
					...
					<tbody id="dashboard_by_me">
						...
						<tr>
							...
							<td>{{ $incident->created_at }}</td>
							<td>{{ $incident->title_short }}</td>
							<td>{{ $incident->support_name?:"Sin asignar" }}</td>
						</tr>
						@endforeach

...
class IncidentController extends Controller
{
    ...
    public function take($id){
        ...
        // There is a relationshioo between user and project ? 
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->input("category_id")){
           ...
           $messages['category_id.exists'] = 'La categoria seleccionada no existe en nuestra base de datos.';
    ...
    public function store(Request $request)
    {
        ...
        return back()->with('notification','La incidencia se registró correctamente.');
    }
